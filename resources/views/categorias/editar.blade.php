<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Actualización de categorias') }}
        </h2>
    </x-slot>
                ...
                <div class="flex justify-between m-6">
                    <div class="flex flex-col h-full max-w-lg mx-auto rounded-lg">
                            ...
                            <form action="{{ route('categorias.update', $categoria->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="">
                                    ...
                                    <input class="appearance-none border-none block w-full bg-gray-200 text-gray-700  rounded py-3 px-4  mb-3  leading-tight focus:outline-none focus:bg-white" id="grid-first-name"
                                        name="NombreCategoria" value="{{$categoria->NombreCategoria}}" type="text" placeholder="Desayuno, Almuerzo, Snacks, Cenas...">
                                </div>
                        </div>

                        <center>
                            <div class="grid grid-cols-1 mt-5 mx-7">
                                <img src="/images/{{ $categoria->imagen }}" width="200px" id="imagenSeleccionada">
                            </div>
                        </center>
                        ...
                        <center>
                            ...
                            <a href="{{ route('categorias.index') }}" class="bg-red-500 shadow-2xl hover:bg-red-700  text-white font-bold py-3 px-10 rounded-full">
                                Cancelar
                            </a>
                        </center><br>
